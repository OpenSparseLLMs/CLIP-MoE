...
def main(args):
    ...
    model, preprocess = clipmoe.loadMoE('checkpoints',top_k=2,num_experts=4,moe_layers=24, device=device) 
    model.to(device)
...
if __name__ == "__main__":
    ...
    args.add_argument('-d', '--data-dir', default='imagenet data', type=str,
